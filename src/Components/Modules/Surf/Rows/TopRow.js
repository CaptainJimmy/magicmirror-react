        ...
        <HOC>
            ...
            <Row>
                    ...
                    <Col style={topStyle} xs={1}>
                        <h4><i className={beaufort} /></h4>
                    </Col>
                    <Col style={topStyle} xs={1}>    
                        <h4><i className={windDirection} /></h4>
                    </Col>
                    <Col style={topStyle} xs={1}>
                        <h4><i className="wi wi-humidity" />{props.weather.currentObservation.relative_humidity.substring(0, props.weather.currentObservation.relative_humidity.length - 1)} </h4>
                    </Col>
                    <Col style={topStyle} xs={2}>
                        {props.daytime ?
                            (<h4><i className="wi wi-sunset" /> {moment(props.sunset).format("HH:mm")} </h4>) :
                            (<h4><i className="wi wi-sunrise" /> {moment(props.sunrise).format("HH:mm")} </h4>)}
                    </Col>
                    <Col style={topStyle} xs={2}>
